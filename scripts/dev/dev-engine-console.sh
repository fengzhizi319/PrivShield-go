#!/usr/bin/env bash
# ============================================================================
# 【开发模式】一键启动 Privacy Engine 专用管理控制台 (Agent + Go BFF + Vite UI)
# Launch Privacy Engine + Engine Console Go BFF + Vite Dev UI in DEV mode
#
# 用法 / Usage:
#   ./scripts/dev/dev-engine-console.sh [--force] [--mtls]
#
# 参数说明 / Options:
